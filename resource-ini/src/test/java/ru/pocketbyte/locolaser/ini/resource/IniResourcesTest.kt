...
class IniResourcesTest {
    ...
    private fun prepareResLocale1(): ResLocale {
        ...
        resLocale.put(prepareResItem("key3", arrayOf(ResValue("value3_1", null, Quantity.ZERO), ResValue("value3_2", null, Quantity.MANY), ResValue("value3_3", null, Quantity.OTHER))))
        return resLocale
    }
