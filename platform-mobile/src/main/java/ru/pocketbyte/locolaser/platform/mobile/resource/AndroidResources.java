 ...
 */
public class AndroidResources extends AbsPlatformResources {

    public AndroidResources(File resourcesDir, String fileName) {
    ...
    protected ResourceFile[] getResourceFiles(Set<String> locales) {
        ...
        for (int i = 0; i < locales.size(); i++) {
            resourceFiles[i] = new AndroidResourceFile(getFileForLocale(localesArray[i]), localesArray[i]);
        }
