...
class AbsResourcesTest {
    ...
    @Test
    fun testConstructor() {
        val resources = MockResources(resFolder!!, NAME, null)
    ...
    fun testRead() {
        ...
        val resources = object : MockResources(resFolder!!, NAME, null) {
    ...
    fun testWriteFiltered() {
        ...
        val resources = object : MockResources(resFolder!!, NAME, filter) {
            override fun getResourceFiles(locales: Set<String>?): Array<ResourceFile>? {
                return arrayOf(res)
            }
        }
