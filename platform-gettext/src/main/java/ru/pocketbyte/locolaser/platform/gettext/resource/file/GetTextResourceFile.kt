...
class GetTextResourceFile(file: File, private val mLocale: String) : ResourceStreamFile(file) {
    ...
    companion object {
        ...
        var GENERATED_GETTEXT_COMMENT = "# AUTO-GENERATED FILE. DO NOT MODIFY.\r\n" +
                "#\r\n" +
        ...
        private val COMMENT_SINGLE_LINE = "#"
        private val KEY_LINE_PATTERN = "msgid \"((?:[^\"]|\\\\\")*)\"\\s*"
        private val VALUE_LINE_PATTERN = "msgstr \"((?:[^\"]|\\\\\")*)\"\\s*"
        private val VALUE_SECOND_LINE_PATTERN = "^[^\\S]*\"((?:[^\"]|\\\\\")*)\"\\s*"
